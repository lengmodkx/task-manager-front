...
export function TagManager({ initialTags, isAdmin }: TagManagerProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* System Tags */}
      <div className="bg-white rounded-lg border p-4">
        <h3 className="font-medium mb-4">系统标签</h3>
        {systemTags.length === 0 ? (
          <p className="text-gray-500 text-sm">暂无系统标签</p>
        ) : (
      ...
      {/* Personal Tags */}
      <div className="bg-white rounded-lg border p-4">
        <h3 className="font-medium mb-4">个人标签</h3>
        {personalTags.length === 0 ? (
          <p className="text-gray-500 text-sm">暂无个人标签</p>
        ) : (
          <div className="space-y-2">
